...
%(3) C
\subsection{Timing Constraints Only Considering DCC Deployment}
\label{subsec:tccc}
...
\end{gather*}}
should be generated such that the solver will not output the corresponding deployment in the result if the CNF is satisfiable. In this case, a total of 1 CNF clause is generated.
While leader count is 2, there exist 9 ($3 \times 3$) possibilities of leader selections (one among buffers ${2, 3, 4}$, the other one among buffers ${5, 6, 7}$).
While leader count is 1, there exist 7 possibilities of leader selections. While leader count is 0, there exist 1 possibilitiy of leader selection.
