...
In order to suppress the occurrence of fragmentary high-$V_{th}$ assignment for clock buffers, the following constraints are incorporated in the framework, such that SAT solver will not output the corresponding $V_{th}$ assignment in the result if the CNF is satisfiable.
