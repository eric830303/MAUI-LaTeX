...
%Note that, we only consider dual-V\textsubscript{th} technology for V\textsubscript{th} assignment in the example: one technology is nominal, the other one is HTV (High Threshold Voltage). Then, 
