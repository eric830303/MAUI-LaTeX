...
\author{Tien-Hung Tseng,
        Shou-Chun Li,
        and~Kai-Chiang Wu,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
\thanks{Tien-Hung Tseng, Shou-Chun Li, and~Kai-Chiang Wu are with the Department
of Computer Science, National Chiao Tung University, Hsinchu, Taiwan (e-mail: kcw@cs.nctu.edu.tw).}% <-this % stops a space
}
