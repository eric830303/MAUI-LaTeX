...
\title{Minimize Aging-Induced Degradation of Performance using Dual-V\textsubscript{th} Technology and Aging Manipulation on Clock Network}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Kai-Chiang Wu,
Tien-Hung Tseng, and
Shou-Chun Li}
\IEEEauthorblockA{Department of Computer Science\\
National Chiao Tung University, Hsinchu, Taiwan \\
E-mail: \{kcw@cs.nctu.edu.tw, eric830303@gmail.com, scli.cs02g@nctu.edu.tw\}}
}
