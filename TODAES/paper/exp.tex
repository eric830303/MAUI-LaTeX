...
To be specific, certain DCC insertions are not allowed before high-$V_{th}$ assignment is employed, due to the violation of timing constraints, The DCC insertions become allowed after high-$V_{th}$ assignment is employed, because timing constraints become met. 
...
%see  Section~\ref{subsec:tccc} and Section~\ref{sec:VTA:timing})
